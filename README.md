...
| `voice` | 20 | `voice.clone`, `voice.dialogue`, `voice.diarize`, `voice.dub`, `voice.list_voices`, `voice.stt`, `voice.tts`, `voice.voicebox_chatterbox`, `voice.voicebox_chatterbox_turbo`, `voice.voicebox_clone`, `voice.voicebox_health`, `voice.voicebox_history`, `voice.voicebox_kokoro`, `voice.voicebox_luxtts`, `voice.voicebox_models`, `voice.voicebox_profiles`, `voice.voicebox_qwen`, `voice.voicebox_qwen_custom`, `voice.voicebox_server`, `voice.voicebox_speak` |
